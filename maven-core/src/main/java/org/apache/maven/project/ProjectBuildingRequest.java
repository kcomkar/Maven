...
public interface ProjectBuildingRequest {
	...
	/**
	 * Controls the level of validation to perform on processed models. By default,
	 * models are validated in strict mode.
	 *
	...
	/**
	 * Set any active profiles that the {@link ProjectBuilder} should consider while
	 * constructing a {@link MavenProject}.
	 */
	...
	/**
	 * Add a {@link org.apache.maven.model.Profile} that has come from an external
	 * source. This may be from a custom configuration like the MavenCLI
	 * settings.xml file, or from a custom dialog in an IDE integration like
	 * M2Eclipse.
	 *
	 * @param profile
	 */
	...
	/**
	 * Sets the merge mode used to combine repositories declared in the POM with the
	 * repositories specified in this request.
	 *
	...
	/**
	 * Gets the merge mode used to combine repositories declared in the POM with the
	 * repositories specified in this request
	 *
	...
	enum RepositoryMerging {
		...
		/**
		 * The repositories declared in the POM have precedence over the repositories
		 * specified in the request.
		 */
		POM_DOMINANT,

		/**
		 * The repositories specified in the request have precedence over the
		 * repositories declared in the POM.
		 */
		REQUEST_DOMINANT,
	}
