...
public class ProjectSorter {
	 ...
	 * <li>iterate through the deps of each project and if that dep is within the
	 * set of projects we want to build then add an edge, otherwise throw the edge
	 * away because that dependency is not within the set of projects we are trying
	 * to build. we assume a closed set.</li>
	 * <li>do a topo sort on the graph that remains.</li>
	 * </ul>
	 * 
	 * @throws DuplicateProjectException if any projects are duplicated by id
	 */
	// MAVENAPI FIXME: the DAG used is NOT only used to represent the dependency
	// relation,
	...
	// in a different lifecycle. Though the compiler-plugin has a valid usecase,
	// although
	...
	private void addEdge(Map<String, MavenProject> projectMap, Map<String, Map<String, Vertex>> vertexMap,
			...
			boolean force, boolean safe) throws CycleDetectedException {
	...
	private void addEdge(Vertex fromVertex, Vertex toVertex, MavenProject fromProject,
			Map<String, MavenProject> projectMap, boolean force, boolean safe) throws CycleDetectedException {
