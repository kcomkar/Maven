...
public interface ProjectBuildingHelper {
	...
	/**
	 * Creates the effective artifact repositories from the specified POM
	 * repositories.
	 *
	 ...
	 *                             to merge into the result list, may be
	 *                             {@code null}.
	 * @param request              The project building request holding further
	 *                             settings like repository settings, must not be
	 *                             {@code null}.
	...
	List<ArtifactRepository> createArtifactRepositories(List<Repository> pomRepositories,
			List<ArtifactRepository> externalRepositories, ProjectBuildingRequest request)
			throws InvalidRepositoryException;

	/**
	 * Creates the project realm that hosts the build extensions of the specified
	 * model.
	 *
	 ...
	 *                {@code null}
	 * @param request The project building request holding further settings like
	 *                repository settings, must not be {@code null}.
	 * @return The record with the project realm and extension artifact filter,
	 *         never {@code null}.
	...
	/**
	 * Updates the context class loader such that the container will search the
	 * project realm when the model builder injects the lifecycle bindings from the
	 * packaging in the next step. The context class loader is to be reset by the
	 * project builder when the project is fully assembled.
	 *
	 * @param project The project whose class realm should be selected, must not be
	 *                {@code null}.
	 */
