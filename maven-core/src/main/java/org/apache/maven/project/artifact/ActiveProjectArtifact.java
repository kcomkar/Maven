 ...
 *         exposes a design flaw in that the immutable and mutable parts of an
 *         artifact are in one class and should be split. ie scope, file, etc
...
public class ActiveProjectArtifact implements Artifact {
	...
	/** {@inheritDoc} */
	public File getFile() {
		// we need to get the latest file for the project, not the artifact that was
