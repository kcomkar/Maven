 ...
 * </ul>
 *
 * @author Jason van Zyl TODO carlos: all these possible has*Exceptions and
 *         get*Exceptions methods make the clients too complex requiring a long
 *         list of checks, need to create a parent/interface/encapsulation for
...
public class ArtifactResolutionResult {
	 ...
	 * returned by {@link #getVersionRangeViolation(int)} but it's not used like
	 * that in DefaultLegacyArtifactCollector
	 */
	...
	public List<Exception> getVersionRangeViolations() {
		return versionRangeViolations == null ? Collections.<Exception>emptyList()
