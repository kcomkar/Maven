...
public interface ProjectDependenciesResolver {
	 ...
	 * @param scopesToResolve The dependency scopes that should be resolved, may be
	 *                        {@code null}.
	 * @param session         The current build session, must not be {@code null}.
	 * @return The transitive dependencies of the specified project that match the
	 *         requested scopes, never {@code null}.
	 */
	 ...
	 * @param project         The project whose dependencies should be resolved,
	 *                        must not be {@code null}.
	 * @param scopesToCollect The dependency scopes that should be collected, may be
	 *                        {@code null}.
	 * @param scopesToResolve The dependency scopes that should be collected and
	 *                        also resolved, may be {@code null}.
	 * @param session         The current build session, must not be {@code null}.
	 * @return The transitive dependencies of the specified project that match the
	 *         requested scopes, never {@code null}.
	 */
	 ...
	 */
	Set<Artifact> resolve(MavenProject project, Collection<String> scopesToCollect, Collection<String> scopesToResolve,
			MavenSession session, Set<Artifact> ignoreableArtifacts)
			throws ArtifactResolutionException, ArtifactNotFoundException;

	/**
	 * Resolves the transitive dependencies of the specified projects. Note that
	 * dependencies which can't be resolved from any repository but are present
	 * among the set of specified projects will not cause an exception. Instead,
	 * those unresolved artifacts will be returned in the result set, allowing the
	 * caller to take special care of artifacts that haven't been build yet.
	 *
	 * @param projects The projects whose dependencies should be resolved, may be
	 *                 {@code null}.
	 * @param scopes   The dependency scopes that should be resolved, may be
	 *                 {@code null}.
	 * @param session  The current build session, must not be {@code null}.
	 * @return The transitive dependencies of the specified projects that match the
	 *         requested scopes, never {@code null}.
	 */
