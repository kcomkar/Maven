...
public class EnvironmentUtils {
	...
	/**
	 * Adds the environment variables in the form of properties whose keys are
	 * prefixed with {@code env.}, e.g. {@code
	 * env.PATH}. Unlike native environment variables, properties are always
	 * case-sensitive. For the sake of determinism, the environment variable names
	 * will be normalized to upper case on platforms with case-insensitive variable
	 * lookup.
	 *
