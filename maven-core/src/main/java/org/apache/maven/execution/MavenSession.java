...
public class MavenSession implements Cloneable {
	 ...
	 * {@link org.apache.maven.Maven} component before being passed into the
	 * session. This is also the potentially constrained set of projects by using
	 ...
	 * Useful in the case where you want to build a smaller set of projects but
	 * perform other operations in the context of your reactor.
	 */
	...
	private final Map<String, Map<String, Map<String, Object>>> pluginContextsByProjectAndPluginKey = new ConcurrentHashMap<>();
	...
	public MavenSession(PlexusContainer container, Settings settings, ArtifactRepository localRepository,
			EventDispatcher eventDispatcher, ReactorManager unused, List<String> goals, String executionRootDir,
			Properties executionProperties, Properties userProperties, Date startTime) {
		this.container = container;
	...
	/**
	 * @deprecated Use either {@link #getUserProperties()} or
