...
public class BuildResumptionData {
	...
	/**
	 * Returns the project where the next build can resume from. This is usually the
	 * first failed project in the order of the reactor.
	 * 
	 * @return An optional containing the group and artifact id of the project. It
	 *         does not make sense to resume the build when the first project of the
	 *         reactor has failed, so then it will return an empty optional.
	 */
	 ...
	 * 
	 * @return A list of group and artifact ids. Can be empty when no projects can
	 *         be skipped.
	 */
