...
public class DefaultLifecycleMapping implements LifecycleMapping {
	...
	/**
	 * Populates the lifecycle map from the injected list of lifecycle mappings (if
	 * not already done).
	 */
	private void initLifecycleMap() {
		if (lifecycleMap == null) {
			...
			if (lifecycles != null) {
				...
				/*
				 * NOTE: This is to provide a migration path for implementors of the legacy API
				 * which did not know about getLifecycles().
				 */
