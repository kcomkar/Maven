...
/**
 * <p>
 * A list of project segments, ordered so that all ProjectSegments from first
 * TaskSegment come before any subsequent TaskSegments.
 * </p>
...
public class ProjectBuildList implements Iterable<ProjectSegment> {
	...
	// TODO Optimize; or maybe just rewrite the whole way aggregating mojos are
	// being run.
	/**
	 * Returns aProjectBuildList that contains only items for the specified
	 * taskSegment
	 * 
