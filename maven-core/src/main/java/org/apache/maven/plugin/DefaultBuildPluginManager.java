...
public class DefaultBuildPluginManager implements BuildPluginManager {
	...
	public void executeMojo(MavenSession session, MojoExecution mojoExecution)
		...
		try {
			...
			// NOTE: DuplicateArtifactAttachmentException is currently unchecked, so be
			// careful removing this try/catch!
			// This is necessary to avoid creating compatibility problems for existing
			// plugins that use
			...
			mojoExecutionListener
					.afterExecutionFailure(new MojoExecutionEvent(session, project, mojoExecution, mojo, e));
	...
	/**
	 * TODO pluginDescriptor classRealm and artifacts are set as a side effect of
	 * this call, which is not nice.
	 * 
