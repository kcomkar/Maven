 ...
 * This is an internal utility interface that is only public for technical
 * reasons, it is not part of the public API. In particular, this interface can
...
public interface PluginDependenciesResolver {
	 ...
	 *
	 * @param plugin           The plugin for which to resolve the dependencies,
	 *                         must not be {@code null}.
	 * @param pluginArtifact   The plugin's main artifact, may be {@code null}.
	 * @param dependencyFilter A filter to exclude artifacts from resolution (but
	 *                         not collection), may be {@code null}.
	 * @param repositories     The plugin repositories to use for resolving the
	 *                         plugin artifacts, must not be {@code null}.
	 * @param session          The repository session to use for resolving the
	 *                         plugin artifacts, must not be {@code null}.
	 * @return The dependency tree denoting the resolved plugin class path, never
	 *         {@code null}.
