...
public class DefaultExceptionHandlerTest {
	/**
	 * Running Maven under JDK7 may cause connection issues because IPv6 is used by
	 * default.
	 * <p>
	 * e.g running mvn site:run will cause Jetty to fail.
	 * </p>
	 * <p>
	 * The resolution is to add -Djava.net.preferIPv4Stack=true to the command line
	 * as documented in
	...
	public void testJdk7ipv6() {
		...
		MojoExecutionException mojoEx = new MojoExecutionException(
