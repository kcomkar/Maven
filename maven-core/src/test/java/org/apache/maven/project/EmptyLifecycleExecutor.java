 ...
 * with the plugin manager and to avoid plugin artifact resolution from
 * repositories.
 *
...
public class EmptyLifecycleExecutor implements LifecycleExecutor {
	...
	public Set<Plugin> getPluginsBoundByDefaultToAllLifecycles(String packaging) {
		...
		// NOTE: The upper-case packaging name is intentional, that's a special hinting
		// mode used for certain tests
