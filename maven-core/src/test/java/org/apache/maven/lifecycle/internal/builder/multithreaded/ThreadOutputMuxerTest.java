...
public class ThreadOutputMuxerTest extends TestCase {
	...
	public void testMultiThreaded() throws Exception {
		...
		final List<String> stringList = Arrays.asList("Thinkin", "of", "a", "master", "plan", "Cuz", "ain’t", "nuthin",
		...
		for (ProjectSegment projectBuild : projectBuildList) {
			final Future<ProjectSegment> buildFuture = service
					.submit(new Outputter(threadOutputMuxer, projectBuild, lyrics.next()));
