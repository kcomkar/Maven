 ...
 *         need the container in here with the active maps (jvz).
 * @since 3.0
 */
...
public class DefaultConflictResolverFactory implements ConflictResolverFactory, Contextualizable {
	...
	/*
	 * @see org.apache.maven.artifact.resolver.conflict.ConflictResolverFactory#
	 * getConflictResolver(java.lang.String)
	 */
	...
	/*
	 * @see org.codehaus.plexus.personality.plexus.lifecycle.phase.Contextualizable#
	 * contextualize(org.codehaus.plexus.context.Context)
	 */
