...
public interface ClasspathTransformation {
	...
	/**
	 * Transform Graph into a Collection of metadata objects that could serve as a
	 * classpath for a particular scope
	 *
	 * @param dirtyGraph - dependency graph
	 * @param scope      - which classpath to extract
	 * @param resolve    - whether to resolve artifacts.
	 * @return Collection of metadata objects in the linked subgraph of the graph
	 *         which contains the graph.getEntry() vertice
	 */
