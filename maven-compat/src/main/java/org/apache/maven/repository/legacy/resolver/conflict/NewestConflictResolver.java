 ...
 * declaration. Newest is defined as the declaration whose version is greater
 * according to <code>ArtifactVersion.compareTo</code>.
 *
...
public class NewestConflictResolver implements ConflictResolver {
	...
	/*
	 * @see
	 * org.apache.maven.artifact.resolver.conflict.ConflictResolver#resolveConflict(
