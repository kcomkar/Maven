...
public interface ArtifactTransformationManager {
	...
	/**
	 * Take in a artifact and return the transformed artifact for locating in the
	 * remote repository. If no transformation has occurred the original artifact is
	 * returned.
	 *
	...
	/**
	 * Take in a artifact and return the transformed artifact for locating in the
	 * local repository. If no transformation has occurred the original artifact is
	 * returned.
	 *
	 * @param artifact        Artifact to be transformed.
	...
	/**
	 * Take in a artifact and return the transformed artifact for distributing to a
	 * remote repository. If no transformation has occurred the original artifact is
	 * returned.
	 *
	 * @param artifact         Artifact to be transformed.
