...
/**
 * metadata graph edge - combination of version, scope and depth define an edge
 * in the graph
 *
...
public class MetadataGraphEdge {
	...
	/**
	 * capturing where this link came from and where it is linked to.
	 *
	...
	public boolean equals(Object o) {
		if (o instanceof MetadataGraphEdge) {
			...
			return objectsEqual(version, e.version) && ArtifactScopeEnum.checkScope(scope).getScope()
					.equals(ArtifactScopeEnum.checkScope(e.scope).getScope()) && depth == e.depth;
		}
		return false;
	}
