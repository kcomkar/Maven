...
public interface MavenProjectBuilder {
	...
	// TODO maven-site-plugin -- not used by the plugin directly, but used by Doxia
	// Integration Tool & MPIR
	...
	// TODO this is only to provide a project for plugins that don't need a project
	// to execute but need some
	// of the values from a MavenProject. Ideally this should be something internal
	// and nothing outside Maven
