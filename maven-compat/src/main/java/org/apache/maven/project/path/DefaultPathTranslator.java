...
public class DefaultPathTranslator implements PathTranslator {
	...
	/**
	 * Removes the leading directory separator from the specified filesystem path
	 * (if any). For platform-independent behavior, this method accepts both the
	 * forward slash and the backward slash as separator.
	 *
	 * @param path The filesystem path, may be <code>null</code>.
	 * @return The altered filesystem path or <code>null</code> if the input path
	 *         was <code>null</code>.
	 */
