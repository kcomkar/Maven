...
public class DebugResolutionListener implements ResolutionListener, ResolutionListenerForDepMgmt {
	 ...
	 * DefaultArtifactCollector, and this method was called right before the actual
	 * version/artifactScope changes were done. However, a different set of
	 * conditionals (and more information) is needed to be able to determine when
	 * and if the version and/or artifactScope changes. See the two added methods,
	 * manageArtifactVersion and manageArtifactScope.
	 */
