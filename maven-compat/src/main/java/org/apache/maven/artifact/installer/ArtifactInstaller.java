...
public interface ArtifactInstaller {
	...
	/**
	 * Install an artifact from a particular directory. The artifact handler is used
	 * to determine the filename of the source file.
	 *
	 ...
	 * @throws ArtifactInstallationException if an error occurred installing the
	 *                                       artifact
	 * @deprecated to be removed before 2.0 after the install/deploy plugins use the
	 *             alternate method
	 */
	@Deprecated
