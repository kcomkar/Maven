 ...
 * {@code DEFAULT_SCOPE} as well as convenience method to deal with scope
 * relationships.
 *
...
public enum ArtifactScopeEnum {
	...
	private static final ArtifactScopeEnum[][][] COMPLIANCY_SETS = { { { compile }, { compile, provided, system } },
			{ { test }, { compile, test, provided, system } }, { { runtime }, { compile, runtime, system } },
