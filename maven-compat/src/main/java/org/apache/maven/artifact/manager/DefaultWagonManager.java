...
public class DefaultWagonManager extends org.apache.maven.repository.legacy.DefaultWagonManager
	...
	// NOTE: This must use a different field name than in the super class or IoC has
	// no chance to inject the loggers
	@Requirement
	private Logger log;
	...
	public ArtifactRepository getMirrorRepository(ArtifactRepository repository) {
		...
		if (mirror != null) {
			...
			repository = artifactRepositoryFactory.createArtifactRepository(id, mirror.getUrl(), repository.getLayout(),
