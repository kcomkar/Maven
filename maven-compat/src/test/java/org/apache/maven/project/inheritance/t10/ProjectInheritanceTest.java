 ...
 * 2. Direct dependencies should override the scope of dependencyManagement. 3.
 * Direct dependencies should inherit scope from dependencyManagement when they
 * do not explicitly state a scope.
 *
