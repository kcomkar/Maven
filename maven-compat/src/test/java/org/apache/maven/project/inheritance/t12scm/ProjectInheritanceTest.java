...
public class ProjectInheritanceTest extends AbstractProjectInheritanceTestCase {
	...
	public void testScmInfoCalculatedCorrectlyOnParentAndChildRead() throws Exception {
		...
		System.out.println();
		System.out.println("Parent SCM developer connection is: " + project0.getScm().getDeveloperConnection());
		System.out.println("Child SCM developer connection is: " + project1.getScm().getDeveloperConnection());
		...
		assertEquals(project1.getScm().getDeveloperConnection(),
				project0.getScm().getDeveloperConnection() + "/modules/p1");
	}
