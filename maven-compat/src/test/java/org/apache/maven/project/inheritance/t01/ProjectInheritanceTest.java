...
/**
 * A test which demonstrates maven's recursive inheritance where we are testing
 * to make sure that elements stated in a model are not clobbered by the same
 * elements elsewhere in the lineage.
 *
