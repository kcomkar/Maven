...
public class ArtifactResolutionExceptionTest extends TestCase {
	...
	public void testMissingArtifactMessageFormat() {
		...
		String actual = AbstractArtifactResolutionException.constructMissingArtifactMessage(message, indentation,
				groupId, artifactId, version, type, classifier, downloadUrl, path);
