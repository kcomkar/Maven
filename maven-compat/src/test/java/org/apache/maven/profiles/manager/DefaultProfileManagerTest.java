...
public class DefaultProfileManagerTest extends PlexusTestCase {
	...
	/*
	 * public void testOsActivationProfile() throws Exception { Profile osActivated
	 * = new Profile(); osActivated.setId( "os-profile" );
	 * 
	 ...
	 * 
	 * Properties props = System.getProperties(); ProfileActivationContext ctx = new
	 * ProfileActivationContext( props, false );
	 * 
