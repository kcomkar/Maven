...
public class DefaultWagonManagerTest extends PlexusTestCase {
	...
	public void testGetRemoteJar() throws TransferFailedException, ResourceDoesNotExistException,
	...
	/**
	 * Check that transfer listeners are properly removed after getArtifact and
	 * putArtifact
	 */
	...
	public void xtestChecksumVerification() throws Exception {
		...
		ArtifactRepository repo = artifactRepositoryFactory.createArtifactRepository("id", "string://url",
