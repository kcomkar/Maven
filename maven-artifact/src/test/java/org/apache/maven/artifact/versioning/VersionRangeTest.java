...
public class VersionRangeTest extends TestCase {
	...
	public void testIntersections() throws InvalidVersionSpecificationException {
		...
		// TODO current policy is to retain the original version - is this correct, do
		// we need strategies or is that handled elsewhere?
//        assertEquals( CHECK_VERSION_RECOMMENDATION, "1.1", mergedRange.getRecommendedVersion().toString() );
	...
	public void testOrder0() {
		// assertTrue( new DefaultArtifactVersion( "1.0-alpha10" ).compareTo( new
		// DefaultArtifactVersion( "1.0-alpha1" ) ) > 0 );
	}
	...
	public void testCache() throws InvalidVersionSpecificationException {
		...
		assertFalse("check !VersionRange.createFromVersionSpec(x).equals(VersionRange.createFromVersion(x))",
				spec.equals(version));
	}
}
