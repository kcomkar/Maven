...
public class ComparableVersionTest extends TestCase {
	...
	/**
	 * Test <a href="https://issues.apache.org/jira/browse/MNG-5568">MNG-5568</a>
	 ...
	 * ComparableVersions() will in some cases throw runtime exception; see Netbeans
	 * issues
	...
	/**
	 * Test <a href="https://jira.apache.org/jira/browse/MNG-6572">MNG-6572</a>
	 * optimization.
	 */
	...
	/**
	 * Test all versions are equal when starting with many leading zeroes regardless
	 * of string length (related to MNG-6572 optimization)
	 */
	...
	/**
	 * Test all "0" versions are equal when starting with many leading zeroes
	 * regardless of string length (related to MNG-6572 optimization)
	 */
	...
	/**
	 * Test <a href="https://issues.apache.org/jira/browse/MNG-6964">MNG-6964</a>
	 * edge cases for qualifiers that start with "-0.", which was showing A == C and
	 * B == C but A &lt; B.
	 */
