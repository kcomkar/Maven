 ...
 * artifact repository.
 *
 * @author <a href="mailto:brett@apache.org">Brett Porter</a> TODO merge with
 *         artifactmetadatasource TODO retrieval exception not appropriate for
 *         store
 */
public interface ArtifactMetadata {
	 ...
	 *
	 * @param metadata the new metadata TODO this should only be needed on the
	 *                 repository metadata
	 */
	 ...
	 * @param remoteRepository the remote repository it came from TODO this should
	 *                         only be needed on the repository metadata
	 */
