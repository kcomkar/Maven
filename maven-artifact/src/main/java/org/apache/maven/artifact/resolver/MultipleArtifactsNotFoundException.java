...
public class MultipleArtifactsNotFoundException extends ArtifactResolutionException {
	...
	/**
	 * @deprecated use
	 *             {@link #MultipleArtifactsNotFoundException(Artifact, List, List, List)}
	 */
	@Deprecated
	 ...
	 * @param remoteRepositories  remote repositories where the missing artifacts
	 *                            were not found
	 */
	public MultipleArtifactsNotFoundException(Artifact originatingArtifact, List<Artifact> resolvedArtifacts,
			List<Artifact> missingArtifacts, List<ArtifactRepository> remoteRepositories) {
