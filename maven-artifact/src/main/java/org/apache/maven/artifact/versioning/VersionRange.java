...
public class VersionRange {
	...
	/**
	 * @deprecated VersionRange is immutable, cloning is not useful and even more an
	 *             issue against the cache
	 * @return a clone
	 */
	@Deprecated
	...
	/**
	 * Creates and returns a new <code>VersionRange</code> that is a restriction of
	 * this version range and the specified version range.
	 * <p>
	 * Note: Precedence is given to the recommended version from this version range
	 * over the recommended version from the specified version range.
	 * </p>
	 *
	 * @param restriction the <code>VersionRange</code> that will be used to
	 *                    restrict this version range.
	 * @return the <code>VersionRange</code> that is a restriction of this version
	 *         range and the specified version range.
	 *         <p>
	 ...
	 *         recommended version of this version range, provided that ranges falls
	 *         within the intersected restrictions. If the restrictions are empty,
	 *         this version range's recommended version is used if it is not
	 *         <code>null</code>. If it is <code>null</code>, the specified version
	 *         range's recommended version is used (provided it is
	 *         non-<code>null</code>). If no recommended version can be obtained,
	 *         the returned version range's recommended version is set to
	 *         <code>null</code>.
	 *         </p>
	...
	public VersionRange restrict(VersionRange restriction) {
		...
		/*
		 * TODO should throw this immediately, but need artifact else { throw new
		 * OverConstrainedVersionException( "Restricting incompatible version ranges" );
		 * }
		 */
	...
	public ArtifactVersion matchVersion(List<ArtifactVersion> versions) {
		// TODO could be more efficient by sorting the list and then moving along the
