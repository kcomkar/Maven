...
public class BuildPomXMLFilterFactory {
	/**
	 * 
	 * @param projectFile will be used by ConsumerPomXMLFilter to get the right
	 *                    filter
	 * @return
	 * @throws SAXException
	...
	public final BuildPomXMLFilter get(Path projectFile)
		...
		if (getDependencyKeyToVersionMapper() != null) {
			ReactorDependencyXMLFilter reactorDependencyXMLFilter = new ReactorDependencyXMLFilter(
