...
public abstract class AbstractXMLFilterTests {
	...
	protected abstract AbstractSAXFilter getFilter()
	...
	protected String transform(String input) throws TransformerException, SAXException, ParserConfigurationException {
	 ...
	 * <q>Your code should not assume that algorithms using char-at-a-time idioms
	 * will be working in characterunits; in some cases they will split characters.
	 ...
	 * internationalized text; the issue isn't unique to XML.</q>
	 * 
	 * @author Robert Scholte
	 */
	class PerCharXMLFilter extends AbstractSAXFilter {
