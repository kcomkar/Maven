...
public interface ProblemCollector {
	 ...
	 *                 {@code -1} if unknown.
	 * @param column   The one-based index of the column containing the problem or
	 *                 {@code -1} if unknown.
	...
	/**
	 * The next messages will be bound to this source. When calling this method
	 * again, previous messages keep their source, but the next messages will use
	 * the new source.
	 * 
	 * @param source
	 */
