...
public class PathAssembler {
	...
	public LocalDistribution getDistribution(WrapperConfiguration configuration) {
		...
		Path distDir = getBaseDir(configuration.getDistributionBase()).resolve(configuration.getDistributionPath())
				.resolve(rootDirName);
		Path distZip = getBaseDir(configuration.getZipBase()).resolve(configuration.getZipPath()).resolve(rootDirName)
				.resolve(baseName);
