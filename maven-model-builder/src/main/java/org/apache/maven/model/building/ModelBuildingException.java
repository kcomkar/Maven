...
/**
 * Signals one ore more errors during model building. The model builder tries to
 * collect as many problems as possible before eventually failing to provide
 * callers with rich error information. Use {@link #getProblems()} to query the
...
public class ModelBuildingException extends Exception {
	 ...
	 * @param modelId  The identifier of the model that could not be built, may be
	 *                 {@code null}.
	...
	/**
	 * Creates a new exception from the specified interim result and its associated
	 * problems.
	 *
	...
	/**
	 * Gets the interim result of the model building up to the point where it
	 * failed.
	 *
	...
	/**
	 * Gets the identifier of the POM whose effective model could not be built. The
	 * general format of the identifier is {@code <groupId>:<artifactId>:<version>}
	 ...
	 *
	 * @return The identifier of the POM or an empty string if not known, never
	 *         {@code null}.
	 */
