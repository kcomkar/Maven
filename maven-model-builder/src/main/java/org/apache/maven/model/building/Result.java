...
public class Result<T> {
	...
	/**
	 * New result - determine whether error or success by checking problems for
	 * errors
	 *
	 * @param model
	 * @param problems
	 ...
	 * newResult(result.get(), concat(result.getProblems(),problems)).
	 *
	 * @param result
	 * @param problem
	 */
	...
	/**
	 * Turns the given results into a single result by combining problems and models
	 * into single collection.
	 *
	 * @param results
	 */
