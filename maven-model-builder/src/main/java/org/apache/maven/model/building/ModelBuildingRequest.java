...
public interface ModelBuildingRequest {
	 ...
	 * processing of POMs from repositories during metadata retrieval.
	 */
	int VALIDATION_LEVEL_MINIMAL = 0;

	/**
	 * Denotes validation as performed by Maven 2.0. This validation level is meant
	 * as a compatibility mode to allow users to migrate their projects.
	 */
	int VALIDATION_LEVEL_MAVEN_2_0 = 20;

	/**
	 * Denotes validation as performed by Maven 3.0. This validation level is meant
	 * for existing projects.
	 */
	int VALIDATION_LEVEL_MAVEN_3_0 = 30;

	/**
	 * Denotes validation as performed by Maven 3.1. This validation level is meant
	 * for new projects.
	 */
	...
	/**
	 * Gets the raw model to build. If not set, model source will be used to load
	 * raw model.
	 *
	...
	/**
	 * Sets the source of the POM to process. Eventually, either
	 * {@link #setModelSource(ModelSource)} or {@link #setPomFile(File)} must be
	 * set.
	 *
	 ...
	 *
	 * @return The POM file of the project or {@code null} if not applicable (i.e.
	 *         when processing a POM from the repository).
	 */
	File getPomFile();

	/**
	 * Sets the POM file of the project to build. Note that providing the path to a
	 * POM file via this method will make the model builder operate in project mode.
	 * This mode is meant for effective models that are employed during the build
	 * process of a local project. Hence the effective model will support the notion
	 * of a project directory. To build the model for a POM from the repository, use
	 * {@link #setModelSource(ModelSource)} in combination with a
	 * {@link FileModelSource} instead.
	 *
	 * @param pomFile The POM file of the project to build the effective model for,
	 *                may be {@code null} to build the model of some POM from the
	 *                repository.
	 * @return This request, never {@code null}.
	 */
	...
	/**
	 * Sets the level of validation to perform on processed models. For building of
	 * projects, {@link #VALIDATION_LEVEL_STRICT} should be used to ensure proper
	 * building. For the mere retrieval of dependencies during artifact resolution,
	 * {@link #VALIDATION_LEVEL_MINIMAL} should be used to account for models of
	 * poor quality. By default, models are validated in strict mode.
	 *
	 ...
	 * If enabled, lifecycle-induced plugin executions will be injected into the
	 * model and common plugin configuration will be propagated to individual
	 * executions.
	 *
	 ...
	 *
	 * @param processPlugins {@code true} to enable plugin processing, {@code false}
	 *                       otherwise.
	 * @return This request, never {@code null}.
	 */
	...
	/**
	 * Indicates whether the model building should happen in two phases. If enabled,
	 * the initial invocation of the model builder will only produce an interim
	 * result which may be used to analyze inter-model dependencies before the final
	 * invocation of the model builder is performed.
	 *
	 * @return {@code true} if two-phase building is enabled, {@code false} if the
	 *         model should be build in a single step.
	 */
	boolean isTwoPhaseBuilding();

	/**
	 * Enables/disables two-phase building. If enabled, the initial invocation of
	 * the model builder will only produce an interim result which may be used to
	 * analyze inter-model dependencies before the final invocation of the model
	 * builder is performed.
	 *
	 * @param twoPhaseBuilding {@code true} to enable two-phase building,
	 *                         {@code false} if the model should be build in a
	 *                         single step.
	 * @return This request, never {@code null}.
	 */
	...
	/**
	 * Indicates whether the model should track the line/column number of the model
	 * source from which it was parsed.
	 *
	 * @return {@code true} if location tracking is enabled, {@code false}
	 *         otherwise.
	 */
	boolean isLocationTracking();

	/**
	 * Enables/disables the tracking of line/column numbers for the model source
	 * being parsed. By default, input locations are not tracked.
	 *
	 * @param locationTracking {@code true} to enable location tracking,
	 ...
	 *
	 * @return The external profiles that should be considered for model building,
	 *         never {@code null}.
	 */
	 ...
	 *
	 * @param profiles The external profiles that should be considered for model
	 *                 building, may be {@code null}.
	 * @return This request, never {@code null}.
	 */
	ModelBuildingRequest setProfiles(List<Profile> profiles);

	/**
	 * Gets the identifiers of those profiles that should be activated by explicit
	 * demand.
	 *
	...
	/**
	 * Sets the identifiers of those profiles that should be activated by explicit
	 * demand.
	 *
	 * @param activeProfileIds The identifiers of those profiles to activate, may be
	 *                         {@code null}.
	 * @return This request, never {@code null}.
	 */
	...
	/**
	 * Gets the identifiers of those profiles that should be deactivated by explicit
	 * demand.
	 *
	...
	/**
	 * Sets the identifiers of those profiles that should be deactivated by explicit
	 * demand.
	 *
	 * @param inactiveProfileIds The identifiers of those profiles to deactivate,
	 *                           may be {@code null}.
	 * @return This request, never {@code null}.
	 */
	...
	/**
	 * Gets the model resolver to use for resolution of mixins or parents that are
	 * not locally reachable from the project directory.
	 *
	...
	/**
	 * Sets the model resolver to use for resolution of mixins or parents that are
	 * not locally reachable from the project directory.
	 *
	 ...
	 *
	 * @param modelBuildingListener The model building listener to notify, may be
	 *                              {@code null}.
	 * @return This request, never {@code null}.
	 */
	...
	/**
	 * Sets the model cache to use for reuse of previously built models. This is an
	 * optional component that serves performance optimizations.
	 *
