...
public interface PluginConfigurationExpander {
	...
	/**
	 * Merges values from general build plugin configuration into the individual
	 * plugin executions of the given model.
	 *
	 * @param model    The model whose build plugin configuration should be
