 ...
 *
 * TODO is there a need for the delegation of MavenMojoDescriptor to this? Why
 * not just extend ComponentDescriptor here?
 */
public class MojoDescriptor extends ComponentDescriptor<Mojo> implements Cloneable {
	...
	/**
	 * The goal name for the Mojo, that users will reference from the command line
	 ...
	 * explicitly set a phase in the POM. <i>Note:</i> This will not automagically
	 * make a mojo run when the plugin declaration is added to the POM. It merely
	 * enables the user to omit the <code>&lt;phase&gt;</code> element from the
	 * surrounding <code>&lt;execution&gt;</code> element.
	 */
	private String phase;

	/**
	 * Specify the version when the Mojo was added to the API. Similar to Javadoc
	 * since.
	 */
	 ...
	 * Javadoc deprecated. This will trigger a warning when a user tries to
	 * configure a parameter marked as deprecated.
	 */
	private String deprecated;

	/**
	 * Flags this Mojo to run it in a multi module way, i.e. aggregate the build
	 * with the set of projects listed as modules. By default, no need to aggregate
	...
	/**
	 * The scope of (transitive) dependencies that should be collected but not
	 * resolved.
	 * 
	 * @since 3.0-alpha-3
	 */
	...
	/**
	 * @param deprecated <code>true</code> to deprecate the Mojo, <code>false</code>
	 *                   otherwise.
	 */
	...
	/**
	 * @param requiresDependencyResolution the new required dependencies in a
	 *                                     specified scope
	 */
	...
	/**
	 * @return the required dependencies in a specified scope TODO the name is not
	 *         intelligible
	 */
	@Deprecated
	 ...
	 * Dependency collection refers to the process of calculating the complete
	 * dependency tree in terms of artifact coordinates. In contrast to dependency
	 * resolution, this does not include the download of the files for the
	 * dependency artifacts. It is meant for mojos that only want to analyze the set
	 * of transitive dependencies, in particular during early lifecycle phases where
	 * full dependency resolution might fail due to projects which haven't been
	 * built yet.
	 *
	 * @return The scope of (transitive) dependencies that should be collected or
	 *         {@code null} if none.
	 * @since 3.0-alpha-3
	 */
	...
	/**
	 * @param requiresProject <code>true</code> if the Mojo needs a Maven project to
	 *                        be executed, <code>false</code> otherwise.
	 */
	...
	/**
	 * @return <code>true</code> if the Mojo needs a Maven project to be executed,
	...
	/**
	 * @param requiresOnline <code>true</code> if the Mojo is online,
	 *                       <code>false</code> otherwise.
	 */
	...
	/**
	 * @return <code>true</code> if the Mojo is online, <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * @param aggregator <code>true</code> if the Mojo uses the Maven project and
	 *                   its child modules, <code>false</code> otherwise.
	 */
	...
	/**
	 * @return <code>true</code> if the Mojo uses the Maven project and its child
	...
	/**
	 * @return <code>true</code> if the Mojo cannot be invoked directly,
	 *         <code>false</code> otherwise.
	 */
	...
	/**
	 * @param directInvocationOnly <code>true</code> if the Mojo cannot be invoked
	...
	/**
	 * @return <code>true</code> if the Mojo needs reports to run,
	 *         <code>false</code> otherwise.
	 */
	...
	/**
	 * @param requiresReports <code>true</code> if the Mojo needs reports to run,
	 *                        <code>false</code> otherwise.
	 */
	...
	/**
	 * @return True if the <code>Mojo</code> is thread-safe and can be run safely in
	 *         parallel
	 * @since 3.0-beta-2
	 */
	...
	/**
	 * @param threadSafe indicates that the mojo is thread-safe and can be run
	 *                   safely in parallel
	 * @since 3.0-beta-2
	 */
	...
	/**
	 * @return {@code true} if this mojo forks either a goal or the lifecycle,
