 ...
 * <code>Mojo</code>, using standard <code>Maven</code> channels.<br>
 * There should be no big surprises here, although you may notice that the
 * methods accept <code>java.lang.CharSequence</code> rather than
 * <code>java.lang.String</code>. This is provided mainly as a convenience, to
 * enable developers to pass things like <code>java.lang.StringBuffer</code>
 * directly into the logger, rather than formatting first by calling
 * <code>toString()</code>.
 *
 * @author jdcasey
 */
