...
public final class DefaultModelResolverTest extends AbstractRepositoryTestCase {
	...
	private ModelResolver newModelResolver() throws ComponentLookupException, MalformedURLException {
		return new DefaultModelResolver(this.session, null, this.getClass().getName(), lookup(ArtifactResolver.class),
				lookup(VersionRangeResolver.class), lookup(RemoteRepositoryManager.class),
