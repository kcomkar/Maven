 ...
 * <em>Note:</em> This component is meant to assist those clients that employ
 * the repository system outside of an IoC container, Maven plugins should
 * instead always use regular dependency injection to acquire the repository
 * system.
 *
...
public final class MavenRepositorySystemUtils {
	 ...
	 * implementations included in this library. To acquire a complete repository
	 * system, clients need to add some repository connectors for remote transfers.
	 *
	 ...
	 * session with values typical for Maven-based resolution. In more detail, this
	 * method configures settings relevant for the processing of dependency graphs,
	 * most other settings remain at their generic default value. Use the various
	 * setters to further configure the session with authentication, mirror, proxy
	 * and other information required for your environment.
	 *
